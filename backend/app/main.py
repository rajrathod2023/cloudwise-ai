...
def create_assessment(request: AssessmentRequest):
    ...
    "architecture": [
        ...
        },
        {
            ...
            "responsibility": (
                "Run the FastAPI backend and process validated assessment requests."
            ),
        },
        {
    ...
    "implementation_phases": [
        ...
        },
        {
            ...
            "description": (
                "Connect Amazon Bedrock and validate structured model responses."
            ),
        },
    ],
    "responsible_ai": {
        ...
        "explanation": (
            ...
            "A qualified person should review the proposed solution before implementation."
        ),
    },
    "security": {
        "iam_controls": [
        ...
        "data_protection_notes": (
            "Do not store AWS credentials, secrets, or unnecessary sensitive data "
            "in application source code or logs."
        ),
    },
    "complexity": "medium",
    "cost_level": "low",
